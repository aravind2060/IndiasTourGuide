...
public class Adapter_For_Places_Punjab extends ArrayAdapter<Data_For_Punjab> {

    Context contextt;

    public Adapter_For_Places_Punjab(Context context, int resource, List<Data_For_Punjab> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final Data_For_Punjab data_for_punjab = getItem(position);
        if (convertView == null) {
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("Image", data_for_punjab.getImageId());
                intent.putExtra("Text", data_for_punjab.getTexte());
                contextt.startActivity(intent);
            }
        });

        imageView.setImageResource(data_for_punjab.getImageId());
        spotname.setText(data_for_punjab.getSpotName());
        place.setText(data_for_punjab.getAddress());
